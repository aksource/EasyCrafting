...
public class VersionHelper {
    ...
    public static final String MOD_ASSETS = "easycrafting";
    ...
    public static void printToChat() {
        ...
        if (updateStatus.equals(UpdateStatus.OUTDATED)) {
            ModEasyCrafting.proxy.printMessageToChat(EnumChatFormatting.YELLOW + "[" + VersionHelper.MOD_NAME + "] " + EnumChatFormatting.RESET + "Using version " + VERSION + " for " + Loader.instance().getMCVersionString());
            ModEasyCrafting.proxy.printMessageToChat(EnumChatFormatting.YELLOW + "[" + VersionHelper.MOD_NAME + "] " + EnumChatFormatting.RESET + "Available version " + updateInfo[1].trim() + ". " + EnumChatFormatting.AQUA + "Consider updating!");
        }
        if (updateInfo != null && updateInfo.length >= 3 && !updateInfo[2].trim().equalsIgnoreCase("null")) {
            ModEasyCrafting.proxy.printMessageToChat(EnumChatFormatting.YELLOW + "[" + VersionHelper.MOD_NAME + "] " + EnumChatFormatting.RESET + updateInfo[2].trim());
        }
    }
